				...
				?>
					<li><a href="#">Laporan</a>
						<ul>
							...
							<li><a href="<?php echo site_url('laporan/view_laporan_permintaan')?>">Laporan Pengajuan Barang Ke RT</a></li>
						</ul>
					</li>
				...
				?>
					...
					<li><a href="#">Laporan</a>
						<ul>
							<li><a target="_blank" href="<?php echo site_url('laporan/laporan_barang')?>">Laporan Barang</a></li>
							<li><a target="_blank" href="<?php echo site_url('laporan/laporan_request')?>">Laporan Permintaan Barang Dari Subunit</a></li>
							<li><a target="_blank" href="<?php echo site_url('laporan/view_laporan_permintaan')?>">Laporan Pengajuan Barang</a></li>
						</ul>
					</li>
					<!--<li><a href="#">Pengajuan</a>
						<ul>
							<li><a href="<?php echo site_url('permintaan')?>">Data Pengajuan Barang Dari SIM</a></li>
						</ul>
					</li>-->
