			...
			<ul>
				...
				?>
					<li><a href="#">Laporan</a>
						<ul>
							...
							<li><a href="<?php echo site_url('laporan/laporan_permintaan')?>">Laporan Permintaan Barang</a></li>
						</ul>
					</li>
				...
				?>
					...
					<li><a href="#">Permintaan</a>
						<ul>
							<li><a href="<?php echo site_url('permintaan')?>">Data Permintaan Barang</a></li>
						</ul>
					</li>
					<li><a href="#">Proses</a>
						<ul>
							<li><a href="<?php echo site_url('topsis/lihat') ?>">Lihat Permintaan</a></li>
						</ul>
					</li>
					<li><a href="#">Laporan</a>
						<ul>
							<li><a target="_blank" href="<?php echo site_url('laporan/laporan_barang')?>">Laporan Barang</a></li>
							<li><a target="_blank" href="<?php echo site_url('laporan/view_laporan_permintaan')?>">Laporan Permintaan Barang</a></li>
						</ul>
					</li>
				...
				?>
					...
					<li><a href="#">Hasil Permintaan</a>
						<ul>
							<li><a href="<?php echo site_url('permintaan/hasil')?>">Hasil Permintaan Barang</a></li>
						</ul>
					</li>
				<?php
					}else{
